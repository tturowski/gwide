...
latex_documents = [
  ('index', 'gwide.tex', u'gwide Documentation',
   u'Zulko', 'manual'),
]
...
man_pages = [
    ('index', 'gwide', u'PACKAGE_NAME Documentation',
     [u'Zulko'], 1)
]
...
texinfo_documents = [
  ('index', 'gwide', u'gwide Documentation',
   u'Zulko', 'gwide', 'One line description of project.',
   'Miscellaneous'),
]
